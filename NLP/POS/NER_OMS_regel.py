...
db_name = "di_aed.v_geld_contract_event"
query_1 = "select oms_regel_1, oms_regel_2, oms_regel_3 from  "
query_2 = " where year = '2015' and verwerking_datum > '2015-11-30' and mutatie_soort_code = '426' and source_ind = 
'D' limit 1000000"
query_call = paste0(query_1,db_name,query_2)
z = as.data.table(dbGetQuery(con_HIVE,query_call))
fwrite(z,"raw_OMS_regel_2.csv")
